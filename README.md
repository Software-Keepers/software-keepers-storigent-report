...
# 📘 Class Directory – Storigent System

# 📘 Directorio de Clases – Storigent System

| **Clase** | **Descripción** | **Atributos (Privados)** | **Métodos (Públicos)** | **Relaciones** |
|------------|-----------------|---------------------------|----------------------|-------------------|
| **User** | Representa a un usuario del sistema, que puede ser una empresa o un emprendedor. | - userId: int  <br> - name: string <br> - email: string <br> - phoneNumber: string <br> - password: string | + login(): void <br> + logout(): void | - Es clase padre de **Company** y **Entrepreneur** |
| **Company** | Representa a una organización registrada en la plataforma. | - companyName: string <br> - address: string <br> - ruc: string | + registerProduct(): void <br> + manageInventory(): void | - Hereda de **User** <br> - Se relaciona con **Product**, **Inventory**, **MonitoringDevice** |
| **Entrepreneur** | Representa a un usuario independiente que gestiona un inventario de menor escala. | - businessType: string | + requestSupport(): void <br> + updateProduct(): void | - Hereda de **User** <br> - Se relaciona con **Product** |
| **Product** | Representa un producto almacenado o fabricado por una empresa o emprendedor. | - productId: int <br> - productName: string <br> - quantity: int <br> - expirationDate: Date | + updateStock(): void <br> + checkQuality(): void | - Asociado a **Inventory**, **MonitoringDevice**, **MaintenanceTask** |
| **Inventory** | Representa el sistema de control de stock de una empresa. | - inventoryId: int <br> - location: string <br> - capacity: int | + addProduct(): void <br> + removeProduct(): void | - Se relaciona con **Product** y **Company** |
| **MonitoringDevice** | Dispositivo IoT utilizado para monitorear las condiciones ambientales de los productos. | - deviceId: int <br> - status: string <br> - temperature: float <br> - humidity: float | + collectData(): void <br> + sendAlert(): void | - Vinculado con **Product** y **MaintenanceTask** |
| **MaintenanceTask** | Tarea programada para mantener o calibrar los dispositivos de monitoreo. | - taskId: int <br> - date: Date <br> - description: string <br> - status: string | + schedule(): void <br> + complete(): void | - Vinculado con **MonitoringDevice** |
| **Feedback** | Permite a los usuarios enviar sugerencias o reportes sobre el uso del sistema. | - feedbackId: int <br> - content: string <br> - date: Date | + submit(): void | - Se relaciona con **User** y **Company** |
| **Report** | Representa reportes o análisis generados por el sistema. | - reportId: int <br> - title: string <br> - generatedAt: Date | + generate(): void <br> + export(): void | - Se relaciona con **Company** y **MonitoringDevice** |
