...
| **Class** | **Description** | **Attributes (Private)** | **Methods (Public)** | **Relationships** |
|------------|-----------------|---------------------------|----------------------|-------------------|
| **User** | Represents a system user, either a company or entrepreneur. | - userId: int  <br> - name: string <br> - email: string <br> - phoneNumber: string <br> - password: string | + login(): void <br> + logout(): void | - Inherited by **Company**, **Entrepreneur** |
| **Company** | Represents an organization registered in the platform. | - companyName: string <br> - address: string <br> - ruc: string | + registerProduct(): void <br> + manageInventory(): void | - Inherits from **User** <br> - Related to **Product**, **Inventory**, **MonitoringDevice** |
| **Entrepreneur** | Represents an independent user managing smaller-scale inventory. | - businessType: string | + requestSupport(): void <br> + updateProduct(): void | - Inherits from **User** <br> - Related to **Product** |
| **Product** | Represents a stored or manufactured product. | - productId: int <br> - productName: string <br> - quantity: int <br> - expirationDate: Date | + updateStock(): void <br> + checkQuality(): void | - Associated with **Inventory**, **MonitoringDevice**, **MaintenanceTask** |
| **Inventory** | Represents a company's stock control system. | - inventoryId: int <br> - location: string <br> - capacity: int | + addProduct(): void <br> + removeProduct(): void | - Related to **Product**, **Company** |
| **MonitoringDevice** | IoT device used to monitor environmental conditions. | - deviceId: int <br> - status: string <br> - temperature: float <br> - humidity: float | + collectData(): void <br> + sendAlert(): void | - Linked to **Product**, **MaintenanceTask** |
| **MaintenanceTask** | Task scheduled for maintaining or calibrating devices. | - taskId: int <br> - date: Date <br> - description: string <br> - status: string | + schedule(): void <br> + complete(): void | - Linked to **MonitoringDevice** |
| **Feedback** | Allows users to provide suggestions or issue reports. | - feedbackId: int <br> - content: string <br> - date: Date | + submit(): void | - Related to **User**, **Company** |
| **Report** | Represents analytics or summaries generated by the system. | - reportId: int <br> - title: string <br> - generatedAt: Date | + generate(): void <br> + export(): void | - Related to **Company**, **MonitoringDevice** |
| **Storigent** | Represents the core system software for storage management. | - systemId: int <br> - version: string | + run(): void <br> + manageUsers(): void | - Central element connecting all contexts |
